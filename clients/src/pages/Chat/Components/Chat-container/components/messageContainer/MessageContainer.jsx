...
import { GET_CHANNEL_MESSAGE, GET_MESSAGES, HOST } from "@/utils/Constants";
...
const MessageContainer = () => {
  ...
  useEffect(() => {
    ...
    if (selectedChatData._id) {
      ...
      else if (selectedChatType === "channel") getChannelMessage();
    }
  ...
  const downloadFile = async (url) => {
    try {
      ...
      if (response.status === 200) {
        ...
        link.setAttribute("download", url.split("/").pop()); // Use file name from URL
